...
\section*{PŘÍLOHA A: Podrobný popis widgetu \It{script} z modulu Analyzér}
\addcontentsline{toc}{section}{PŘÍLOHA A: Podrobný popis widgetu \It{script} z modulu Analyzér}
\label{script_ref}
Script widget umožňuje parsování dat pomocí scriptu, který se píše v QtScriptu, který je založený na standartu ECMAScript, na kterém je založený JavaScript. Prostě je to hodně podobné JavaScriptu a většinou můžete použít jeho referenci. Tento text předpokládá alespoň základní znalost JavaScriptu nebo podobného programovacího jazyku.
...
\subsection*{Pár věcí na které je třeba myslet}
...
\addcontentsline{toc}{section}{PŘÍLOHA C: Seznam obrázků} % pøidá seznam obrázkù do obsahu 
