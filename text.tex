...
Robot našeho týmu byl poměrně jednoduchý, přesto však obsahoval 5 ultrazvukových dálkoměrů, dva enkodéry a 5 tlačítek (detekce nárazu na mantinel a pěšce, kterého mohl robot převážet). Tyto senzory produkují poměrně značné množství dat, které se v terminálu zobrazuje nepřehledně.
