...
\subsection*{Osobní cíle}
    ...
    Qt Framework jsem zvolil protože jsem chtěl zkusit naprogramovat program s~GUI (do té doby jsem pracoval většinou se serverovým emulátorem MaNGOS \cite{mangos} a programy pro mikrokontroléry). Qt umožňuje vytvoření GUI pro vícero platforem s~jedním zdrojovým kódem.
...
% seznam samozřejmě změníte podle svého, tohle je pouze ukázka formátování
  ...
  \bibitem{mangos} \It{Massive Network Game Object Server - MaNGOS} \\
   \verb#http://getmangos.com#% (Stav ke dni 8.3.2011)
