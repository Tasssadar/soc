...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.72]{img/use_pid.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.25]{img/use_david_robot.jpg}
...
Aplikace je nadále vyvíjena, můžu prakticky donekonečna přídávat buďto další typy widgetů do modulu Analyzér (například kompas, směrový kříž, ...) nebo celé nové moduly (například ovládání robota pomocí joysticku). Program má v současné době (8.3.2012) asi 14 a půl tisíce řádků kódu (bez knihoven třetích stran).
\begin{figure}[H]
\begin{center}
