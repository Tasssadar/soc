...
% TODO: odkaz
Pro získání ucelenější představy o tom co vše lze pomocí sady Lorris dosáhnout, prosím nahlédněte do kapitoly XXXXXX
...
\voffset = -35mm % posun začátku textu výš
\begin{center}
...
\begin{itemize}
    ...
    \item {\bf EcWin7}\cite{ecwin7} je knihovna, která poskytuje jednoduché rozhraní k indikátoru průběhu
    \item {\bf QScintilla2}\cite{qsci} je distribuována pod GNU GPL v2 a v3
    \item {\bf libenjoy}\cite{libenjoy} je distribuována pod GNU LGPLv2.1
    \item {\bf PythonQt}\cite{pythonqt} je distribuována pod GNU LGPLv2.1
    \item {\bf Python}\cite{python} je distribuován pod PSF License agreement\cite{psf}
    \item {\bf Qt Solutions}\cite{qtsolutions} je distribuován pod The New BSD License
    \item {\bf libyb}\cite{libyb} je distribuován pod Boost Software License\cite{boost}
\end{itemize}
...
\begin{itemize}
    ...
    \item {\bf libenjoy} je distribuována pod GNU LGPLv2.1
