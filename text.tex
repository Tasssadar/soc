...
Widget "Robot" uprostřed reprezentuje tělo robota. Widgety "číslo" s názvy "Ultra E0...8" ukazují vzdálenost z ultrazvukových měřáků vzálenosti. Ve widgetu "Ultra E0" je vzdálenost menší než 25 cm, což je hraniční vzdálenost po které se robot zastaví aby nevrazil do soupeře - aby na tuto skutečnost upozornil, má červené pozadí.

Widgety "barva" s názvy "btn" jsou tlačítka značící náraz do senzoru a "pwn" je tlačítko které se stiskne pokud je v robotovi pěšec. Tlačítko které má zelenou barvu není stisklé, tlačítko s červenou barvou stisklé je.
