...
\institute[vbocek@gmail.com]{SPŠ a VOŠ technická, Sokolská 1, Brno \\[0.5cm]}
\title{LORRIS TOOLBOX}
...
\begin{frame}
    ...
    \begin{center}
	    \begin{tikzpicture}
		  \node[drop shadow={shadow xshift=.8ex,shadow yshift=-.8ex},fill=white,draw] at (0,0) {   		\includegraphics[scale=0.3]{img/stroj_mech.jpg}};
		\end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\column{.5\textwidth}
   			\begin{center}
		    \begin{tikzpicture}
\node[drop shadow={shadow xshift=.8ex,shadow yshift=-.8ex},fill=white,draw] at (0,0) {   		\includegraphics[scale=0.4]{img/car_old.jpg}};
			\end{tikzpicture}
			\end{center}
		\column{.5\textwidth}
			\begin{center}
		    \begin{tikzpicture}
\node[drop shadow={shadow xshift=.8ex,shadow yshift=-.8ex},fill=white,draw] at (0,0) {   		\includegraphics[scale=0.4]{img/car_new.jpg}};
			\end{tikzpicture}
			\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\column{.4\textwidth}
   			\begin{center}
		    \begin{tikzpicture}
\node[drop shadow={shadow xshift=.8ex,shadow yshift=-.8ex},fill=white,draw] at (0,0) {   		\includegraphics[scale=0.4]{img/eng_old.jpg}};
			\end{tikzpicture}
			\end{center}
		\column{.6\textwidth}
			\begin{center}
		    \begin{tikzpicture}
\node[drop shadow={shadow xshift=.8ex,shadow yshift=-.8ex},fill=white,draw] at (0,0) {   		\includegraphics[scale=0.37]{img/eng_new.jpg}};
			\end{tikzpicture}
			\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\column{.5\textwidth}
   			\begin{center}
		    \begin{tikzpicture}
\node[drop shadow={shadow xshift=.8ex,shadow yshift=-.8ex},fill=white,draw] at (0,0) {   		\includegraphics[scale=0.4]{img/ele_old.png}};
			\end{tikzpicture}
			\end{center}
		\column{.5\textwidth}
			\begin{center}
		    \begin{tikzpicture}
\node[drop shadow={shadow xshift=.8ex,shadow yshift=-.8ex},fill=white,draw] at (0,0) {   		\includegraphics[scale=0.4]{img/ele_new.png}};
			\end{tikzpicture}
			\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
	    \begin{tikzpicture}
		  \node[drop shadow={shadow xshift=.8ex,shadow yshift=-.8ex},fill=white,draw] at (0,0) {   		\includegraphics[scale=0.33]{img/prog.png}};
		\end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
	    \begin{tikzpicture}
		  \node[drop shadow={shadow xshift=.8ex,shadow yshift=-.8ex},fill=white,draw] at (0,0) {   		\includegraphics[scale=0.43]{img/analyzer.png}};
		\end{tikzpicture}
    \end{center}
\end{frame}
